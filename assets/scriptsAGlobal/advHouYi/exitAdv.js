...
cc.Class({
   ...
   onShowFinished(scene) {
      console.log('==哪个场景打开了退出广告', scene);
   },
   onCloseFullAdv() {
      if (this._canClose) {
         G_UIManager.hideUI('exitAdv');
...
// let Cls_BasePopup = require("base_popup");
// let ccUtils = require('cc_utils').getInstance();
...
//    properties: {},
//    onLoad() {
//       ccUtils.registerBtnClick(this, 'close', this.onCloseFullAdv);
//    },
//    onEnable() {
//       if (IssuePlat !== 'wx' && IssuePlat !== 'pc') {
//          this.onCloseFullAdv();
//       }
//    },
//    onShowFinished(a) { },
